<template>
    <div class="billsInterest" :style="{'min-height':heigh-150+'px'}">
        <div v-if="!backData">
          ...
          <el-table :data="tableData" style="width: 100%" border>
              ...
              <el-table-column prop="finaNumber" label="应付账款编号" align="center"></el-table-column>
              <el-table-column prop="orderNumber" label="应付账款金额（元）" align="center" width="148"></el-table-column>
              <el-table-column prop="company" label="本金金额（元）" align="center"></el-table-column>
              <el-table-column prop="payMoney" label="利息金额（元）" align="center"></el-table-column>
              <el-table-column prop="otMoney" label="付款单位" align="center"></el-table-column>
              <el-table-column prop="otMoney" label="收款单位" align="center"></el-table-column>
        ...
        <apy-register :backData = "backData" v-if="backData == 'interestReg'" v-on:headCallBack="headCall"></apy-register>
      <apyCheck :backData = "backData" v-if="backData == 'interestCheck'" v-on:headCallBack="headCall"></apyCheck>
    </div>
</template>
...
export default {
  ...
  methods: {
    ...
    hrefBills(is, data) {
      if (is === "支付登记") {
        this.backData = "interestReg";
      } else {
        this.backData = "interestCheck";
      }
    }
  },
  watch: {}
